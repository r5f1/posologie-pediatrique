...
var UI = {
  ...
  askCourse: T('How many mL must be prepared for the WHOLE course?', 'Combien de mL faut-il préparer pour TOUTE la cure ?'),
  askBottlesA: T('The pharmacy stocks ', 'La pharmacie a des bouteilles de '),
  askBottlesB: T(' mL bottles. How many bottles must be dispensed for the whole course?', ' mL. Combien de bouteilles faut-il servir pour toute la cure ?'),
  unitBottles: T('bottles', 'bouteilles'),
  unitBottle: T('bottle', 'bouteille'),
  prescribedFor: T('Prescribed for', 'Prescrit pour'),
  days: T('days', 'jours'),
  ...
  w1: T('Calculator — pick a diagnosis, enter a weight, and get the dose in milligrams and in millilitres, with Quebec concentrations and the adult maximum already applied.',
        'Calcul — choisissez un diagnostic, entrez un poids, et obtenez la dose en milligrammes et en millilitres, avec les concentrations du Québec et le maximum adulte déjà appliqué.'),
  w2: T('Method — how mg/kg dosing actually works, from the basic rule to the mistakes that cause real harm.',
        'Méthode — comment fonctionne vraiment le calcul mg/kg, de la règle de base jusqu\'aux erreurs qui font réellement mal.'),
  w3: T('Practice — orders generated endlessly, clinical and pharmacy alike. Get one wrong and it names the exact arithmetic slip you made.',
        'Pratique — des ordonnances générées sans fin, cliniques comme pharmaceutiques. En cas d\'erreur, l\'application nomme exactement le faux pas de calcul.'),
  w4: T('Reference — every drug, what it treats, what to watch for, and the nursing care around it.',
        'Référence — chaque médicament, ce qu\'il traite, ce qu\'il faut surveiller et la surveillance infirmière qui l\'entoure.'),
  wEnd: T('Everything is bilingual. It is a study tool, never a clinical reference.',
          'Tout est bilingue. C\'est un outil d\'étude, jamais une référence clinique.'),
  wOk: T('Start practicing', 'Commencer à pratiquer'),
  nTitle: T('Before you practice', 'Avant de vous exercer'),
  nLead: T('This is a study tool built as a student project. Please treat it as one.',
           'C\'est un outil d\'étude réalisé comme projet étudiant. Traitez-le comme tel.'),
  n1: T('It still has bugs, and a dose in it may simply be wrong.',
        'Il contient encore des bogues, et une dose peut tout simplement être erronée.'),
  n2: T('Never use it to prepare, verify or give a medication to a real patient.',
        'Ne l\'utilisez jamais pour préparer, vérifier ou administrer un médicament à un vrai patient.'),
  n3: T('Every number has to be confirmed in RxVigilance, the Guide des médicaments, the product monograph, or with a pharmacist.',
        'Chaque chiffre doit être confirmé dans RxVigilance, le Guide des médicaments, la monographie du produit ou auprès d\'un pharmacien.'),
  n4: T('What it is genuinely good for: drilling the arithmetic until it becomes automatic.',
        'Ce à quoi il sert vraiment : répéter le calcul jusqu\'à ce qu\'il devienne automatique.'),
  nOk: T('I understand', 'J\'ai compris'),
  nStrip: T('Practice tool, bugs included. Never for a real patient.',
            'Outil d\'exercice, bogues compris. Jamais pour un vrai patient.'),
  nReopen: T('Read the notice', 'Revoir l\'avis'),
